...
using hls::sim::Byte;
extern "C" void winning(Byte<1>*, volatile void *);
extern "C" void apatb_winning_hw(volatile void * __xlx_apatb_param_board, volatile void * __xlx_apatb_param_result) {
using hls::sim::createStream;
  // Collect __xlx_board__tmp_vec
std::vector<Byte<1>> __xlx_board__tmp_vec;
for (size_t i = 0; i < 42; ++i){
__xlx_board__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_board)[i]);
}
  int __xlx_size_param_board = 42;
  int __xlx_offset_param_board = 0;
  int __xlx_offset_byte_param_board = 0*1;
  // DUT call
  winning(__xlx_board__tmp_vec.data(), __xlx_apatb_param_result);
// print __xlx_apatb_param_board
for (size_t i = 0; i < __xlx_size_param_board; ++i) {
((Byte<1>*)__xlx_apatb_param_board)[i] = __xlx_board__tmp_vec[__xlx_offset_param_board+i];
}
}
