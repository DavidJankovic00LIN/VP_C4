...
// wrapc file define:
#define AUTOTB_TVIN_board "../tv/cdatafile/c.winning.autotvin_board.dat"
#define AUTOTB_TVOUT_board "../tv/cdatafile/c.winning.autotvout_board.dat"
#define AUTOTB_TVIN_result "../tv/cdatafile/c.winning.autotvin_result.dat"
#define AUTOTB_TVOUT_result "../tv/cdatafile/c.winning.autotvout_result.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_result "../tv/rtldatafile/rtl.winning.autotvout_result.dat"
...
extern "C"
void winning_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_winning_hw(void* __xlx_apatb_param_board, void* __xlx_apatb_param_result)
{
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_board),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_board),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_board };
  port1.nbytes = { 42 };
  port1.offset = {  };
  ...
  try {
    ...
    winning_hw_stub_wrapper(__xlx_apatb_param_board, __xlx_apatb_param_result);
